...
export default function Form8915fPage() {
  ...
  async function handleSave(andAnother=false) {
    setSaving(true)
    await fetch(`/api/returns/${id}/income/8915f`, {
  ...
  return (
    <div className="root">
      ...
      <main className="main">
        <div className="breadcrumb">Income › Form 8915-F</div>
        <h1 className="title">Form 8915-F</h1>
