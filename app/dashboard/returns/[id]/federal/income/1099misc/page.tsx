...
export default function Form1099miscPage() {
  ...
  return (<div className="root"><ReturnNav returnId={id} taxYear={2025} />
    <main className="main">
      <h1 className="title">Form 1099-MISC <span className="ref">Miscellaneous Income</span></h1>
      ...
      <div className="card"><h2>Income Boxes</h2>
        <div className="row">
          <MF label="Box 1 — Rents" fkey="box1" fields={fields} set={set} />
          <MF label="Box 2 — Royalties" fkey="box2" fields={fields} set={set} />
          <MF label="Box 3 — Other income" fkey="box3" fields={fields} set={set} />
        </div>
        <div className="row">
          <MF label="Box 4 — Federal tax withheld" fkey="box4" fields={fields} set={set} />
          <MF label="Box 5 — Fishing boat proceeds" fkey="box5" fields={fields} set={set} />
          <MF label="Box 6 — Medical & healthcare payments" fkey="box6" fields={fields} set={set} />
        </div>
        <div className="row">
          <MF label="Box 7 — Payer made direct sales > $5,000" fkey="box7" fields={fields} set={set} />
          <MF label="Box 8 — Substitute payments" fkey="box8" fields={fields} set={set} />
          <MF label="Box 9 — Crop insurance proceeds" fkey="box9" fields={fields} set={set} />
        </div>
        <div className="row">
          <MF label="Box 10 — Gross proceeds to attorney" fkey="box10" fields={fields} set={set} />
          <MF label="Box 11 — Fish purchased" fkey="box11" fields={fields} set={set} />
          <MF label="Box 12 — Section 409A deferrals" fkey="box12" fields={fields} set={set} />
        </div>
        <div className="row">
          <MF label="Box 14 — Nonqualified deferred comp" fkey="box14" fields={fields} set={set} />
