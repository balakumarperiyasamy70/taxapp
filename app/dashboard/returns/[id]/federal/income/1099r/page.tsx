...
export default function Form1099rPage() {
  ...
  async function handleSave(andAnother=false) {
    setSaving(true)
    await fetch(`/api/returns/${id}/income/1099r`, {
  ...
  return (
    <div className="root">
      ...
      <main className="main">
        <div className="breadcrumb">Income › Form 1099-R, RRB, SSA</div>
        <h1 className="title">Form 1099-R, RRB, SSA</h1>
