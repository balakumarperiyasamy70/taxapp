...
export default function 1099kPage() {
  ...
  async function handleSave(andAnother=false) {
    setSaving(true)
    await fetch(`/api/returns/${id}/income/1099k`, {
  ...
  return (
    <div className="root">
      ...
      <main className="main">
        <div className="breadcrumb">Income › Form 1099-K</div>
        <h1 className="title">Form 1099-K</h1>
