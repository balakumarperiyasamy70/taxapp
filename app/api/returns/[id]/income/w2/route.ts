...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const item = await prisma.incomeItem.create({
    data: {
      returnId: params.id,
      type: "W2",
      payerName: body.employerName ?? null,
      payerEin: body.ein ?? null,
      amount: new Prisma.Decimal(body.box1Wages || 0),
      federalWithheld: body.box2Federal != null ? new Prisma.Decimal(body.box2Federal) : null,
